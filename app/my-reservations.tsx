...
const styles = StyleSheet.create({
  ...
  title: { color: NAVY, fontFamily: 'Inter_700Bold', fontSize: 20, fontWeight: '700' },
  ...
  date: { color: NAVY, fontFamily: 'Inter_700Bold', fontSize: 14, fontWeight: '700' },
  time: { color: NAVY, fontFamily: 'Inter_700Bold', fontSize: 15, fontWeight: '700', marginTop: 5 },
  ...
  city: { color: NAVY, fontFamily: 'Inter_400Regular', fontSize: 12, fontWeight: '400' },
  place: { color: NAVY, fontFamily: 'Inter_700Bold', fontSize: 15, lineHeight: 18, fontWeight: '700', marginTop: 1 },
  ...
  footerValue: { color: NAVY, fontFamily: 'Inter_500Medium', fontSize: 14, fontWeight: '500', marginTop: 1 },
  reservationNumber: { color: NAVY, fontFamily: 'Inter_500Medium', fontSize: 14, fontWeight: '500', marginTop: 1 },
