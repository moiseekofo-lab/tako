...
const styles = StyleSheet.create({
  ...
  card: { borderWidth: 1, borderColor: '#D8DCE3', borderRadius: 18, backgroundColor: 'white', marginBottom: 15, overflow: 'hidden' },
  cardMain: { minHeight: 164, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 18, paddingVertical: 14 },
  cardMainCompact: { paddingHorizontal: 11, minHeight: 158 },
  dateColumn: { width: 84 },
  dateColumnCompact: { width: 70 },
  ...
  routeLine: { width: 31, height: 108, alignItems: 'center', justifyContent: 'space-between' },
  routeCircle: { width: 18, height: 18, borderRadius: 9, borderWidth: 1.5, borderColor: '#6B7280', backgroundColor: 'white' },
  routeVertical: { position: 'absolute', top: 17, width: 1.5, height: 67, backgroundColor: '#6B7280' },
  ...
  routeGap: { height: 8 },
  cardFooter: { minHeight: 68, borderTopWidth: 1, borderTopColor: '#D8DCE3', flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 18, paddingVertical: 10 },
  ...
  cancelButton: { height: 40, borderTopWidth: 1, borderTopColor: '#EEF0F4', alignItems: 'center', justifyContent: 'center' },
