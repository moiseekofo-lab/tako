        ...
        <ScrollView
          ...
          <View style={[styles.topBar, isNarrow && styles.mobileTopBar]}>
            <View>
              ...
              <Text style={styles.title}>{activeSection === 'profile' ? (profileCurrentTab === 'security' ? 'Sécurité' : 'Mon profil') : adminNavTranslations[language][activeSection]}</Text>
              <Text style={styles.subtitle}>
                {activeSection === 'dashboard' ? 'Vue générale de l’activité TaKo.' : activeSection === 'profile' ? (profileCurrentTab === 'security' ? 'Gérez la sécurité de votre compte et protégez vos données.' : 'Consultez et gérez vos informations personnelles.') : 'Gestion et suivi des opérations.'}
              </Text>
            </View>
