...
const styles = StyleSheet.create({
  ...
  phonePreview: { color: NAVY, fontSize: 18, lineHeight: 24, fontWeight: '800', marginTop: 0, marginBottom: 10 },
  otpInstruction: { color: MUTED, fontSize: 16, lineHeight: 22, marginBottom: 26 },
