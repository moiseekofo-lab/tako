...
const styles = StyleSheet.create({
  ...
  routeBox: { borderWidth: 1, borderColor: '#DDE2EA', borderRadius: 12, overflow: 'hidden' }, routeRow: { height: 55, flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 16 }, routeText: { color: '#303744', fontFamily: 'Inter_600SemiBold', fontSize: 16, fontWeight: '600' }, routeDivider: { height: 1, backgroundColor: '#E5E8EE', marginLeft: 50 },
  ...
  cityList: { maxHeight: 232 }, cityRow: { height: 58, flexDirection: 'row', alignItems: 'center', gap: 16, paddingHorizontal: 18, borderBottomWidth: 1, borderBottomColor: '#F0F2F5' }, cityText: { color: '#303642', fontFamily: 'Inter_500Medium', fontSize: 17, fontWeight: '500' }, noCity: { color: '#7A8393', fontFamily: 'Inter_400Regular', fontSize: 15, textAlign: 'center', paddingVertical: 28 },
  calendarBackdrop: { flex: 1, backgroundColor: 'rgba(1,15,50,.48)', alignItems: 'center', justifyContent: 'center', padding: 22 }, calendarCard: { width: '100%', maxWidth: 390, backgroundColor: 'white', borderRadius: 18, padding: 18 }, calendarHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18 }, calendarTitle: { color: '#061F68', fontFamily: 'Inter_700Bold', fontSize: 18, fontWeight: '700', textTransform: 'capitalize' }, weekRow: { flexDirection: 'row' }, weekDay: { width: '14.285%', color: '#748094', fontFamily: 'Inter_600SemiBold', fontSize: 14, fontWeight: '600', textAlign: 'center' }, dayGrid: { flexDirection: 'row', flexWrap: 'wrap', marginTop: 8 }, dayCell: { width: '14.285%', height: 43, alignItems: 'center', justifyContent: 'center' }, dayCircle: { width: 36, height: 36, borderRadius: 18, alignItems: 'center', justifyContent: 'center' }, daySelected: { backgroundColor: '#0877EA' }, dayText: { color: '#061F68', fontFamily: 'Inter_500Medium', fontSize: 16, fontWeight: '500' }, dayDisabled: { color: '#C2C7D0' }, dayTextSelected: { color: 'white', fontFamily: 'Inter_700Bold', fontWeight: '700' }, closeCalendar: { alignSelf: 'flex-end', marginTop: 10, paddingHorizontal: 8, paddingVertical: 6 }, closeCalendarText: { color: '#0877EA', fontFamily: 'Inter_600SemiBold', fontSize: 16, fontWeight: '600' },
});
