  ...
  return <SafeAreaView style={styles.page}><ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
    ...
    <View style={styles.body}>
      ...
      <View style={styles.seatCard}>
        <View style={styles.tabs}><TouchableOpacity style={[styles.tab, !automatic && styles.tabActive]} onPress={() => setAutomatic(false)}><Ionicons name="grid-outline" size={17} color="#0758D0" /><Text style={styles.tabText}>Plan du bus</Text></TouchableOpacity><TouchableOpacity style={[styles.tab, automatic && styles.tabActive]} onPress={selectAutomatically}><Ionicons name="color-wand-outline" size={17} color="#555B66" /><Text style={styles.tabMuted}>Choisir automatiquement</Text></TouchableOpacity></View>
...
const styles = StyleSheet.create({
  ...
  sectionTitle:{flexDirection:'row',alignItems:'center',gap:8,marginTop:18,marginBottom:9},sectionTitleText:{fontSize:18,fontWeight:'900',color:'#061F68'},passengerCard:{backgroundColor:'#fff',borderRadius:13,padding:14,marginBottom:8,borderWidth:1,borderColor:'#ECEEF3'},passengerTitle:{fontSize:14,fontWeight:'900',marginBottom:8},inputGrid:{flexDirection:'row',flexWrap:'wrap',gap:10},inputWrap:{width:'48%'},inputLabel:{fontSize:11,color:'#555B66',marginBottom:5},input:{height:42,borderWidth:1,borderColor:'#D9DDE5',borderRadius:7,paddingHorizontal:10,flexDirection:'row',alignItems:'center',gap:8},textInput:{flex:1,fontSize:12,color:'#111',paddingVertical:0},
  seatCard:{backgroundColor:'#fff',borderRadius:13,padding:12,borderWidth:1,borderColor:'#ECEEF3'},tabs:{height:39,borderWidth:1,borderColor:'#E5E8EF',borderRadius:7,flexDirection:'row'},tab:{flex:1,flexDirection:'row',gap:7,alignItems:'center',justifyContent:'center'},tabActive:{backgroundColor:'#EAF2FF'},tabText:{fontSize:12,color:'#0758D0',fontWeight:'800'},tabMuted:{fontSize:11,color:'#555B66'},seatContent:{flexDirection:'row',paddingTop:12,alignItems:'flex-start'},busPlan:{width:'63%',backgroundColor:'#F2F6FC',borderRadius:35,padding:10},windshield:{height:25,borderRadius:20,backgroundColor:'#CBD6E9',marginBottom:8},columnLabels:{flexDirection:'row',alignItems:'center',marginBottom:5},rowNumberSpace:{width:24},columnLabel:{flex:1,textAlign:'center',fontSize:10,color:'#394150'},seatViewport:{height:181},seatRows:{gap:5,paddingBottom:4},seatRow:{flexDirection:'row',alignItems:'center',gap:5},rowNumber:{width:19,textAlign:'center',fontSize:9,color:'#394150'},seat:{flex:1,height:31,borderRadius:4,backgroundColor:'#128BF1',alignItems:'center',justifyContent:'center'},seatUnavailable:{backgroundColor:'#D8DADF'},seatSelected:{backgroundColor:'#08A56E'},legend:{flex:1,paddingLeft:12,paddingTop:18},legendRow:{flexDirection:'row',alignItems:'center',gap:7,marginBottom:12},legendColor:{width:15,height:15,borderRadius:4},legendText:{fontSize:10,color:'#181A1F'},selectedBox:{marginTop:18,borderWidth:1,borderColor:'#E2E5EB',borderRadius:8,padding:10},selectedLabel:{fontSize:10,color:'#333'},selectedValue:{fontSize:18,fontWeight:'900',color:'#08A56E',marginTop:5},
