...
export default function TravelBooking() {
  ...
  return <View style={styles.page}><ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[styles.scroll, { paddingBottom: 42 + insets.bottom }]}>
...
const styles = StyleSheet.create({
  page:{flex:1,backgroundColor:'#F8FAFE'},scroll:{paddingBottom:42},hero:{minHeight:124,paddingHorizontal:20,paddingBottom:12,flexDirection:'row',alignItems:'center'},back:{width:48,height:48,alignItems:'center',justifyContent:'center'},heroCopy:{flex:1,alignItems:'center'},heroTitle:{color:'#061F68',fontSize:23,fontWeight:'900'},heroSubtitle:{color:'#667085',fontSize:14,marginTop:4},heroSide:{width:48},body:{backgroundColor:'#F8FAFE',paddingHorizontal:18,paddingTop:8,paddingBottom:24},
