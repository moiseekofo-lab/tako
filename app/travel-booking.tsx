...
const styles = StyleSheet.create({
  page:{flex:1,backgroundColor:'#F8FAFE'},scrollView:{flex:1},scroll:{paddingBottom:8},hero:{minHeight:104,paddingHorizontal:16,paddingBottom:8,flexDirection:'row',alignItems:'center'},back:{width:42,height:42,alignItems:'center',justifyContent:'center'},heroCopy:{flex:1,alignItems:'center'},heroTitle:{color:'#061F68',fontSize:21,fontWeight:'900'},heroSubtitle:{color:'#667085',fontSize:13,marginTop:2},heroSide:{width:42},body:{backgroundColor:'#F8FAFE',paddingHorizontal:16,paddingTop:2,paddingBottom:8},
