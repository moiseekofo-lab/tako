...
export default function DriverDashboard() {
  ...
  const todayGains = trips.filter((trip) => new Date(trip.createdAt).toDateString() === new Date().toDateString())
    ...
    <View style={styles.main}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.metrics}>
          ...
          <Panel style={styles.metric}><View style={[styles.metricIcon,{backgroundColor:'#dff8e9'}]}><MaterialCommunityIcons name="chart-line" size={26} color="#12a85b" /></View><View><Text style={styles.metricLabel}>Gains du jour</Text><Text style={styles.metricValue}>{money(todayGains)}</Text><Text style={styles.positive}>+15% par rapport à hier</Text></View></Panel>
