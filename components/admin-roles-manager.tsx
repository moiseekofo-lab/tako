...
const styles = StyleSheet.create({
  page: { gap: 14 }, tabs: { minHeight: 47, flexDirection: 'row', backgroundColor: 'white', borderWidth: 1, borderColor: '#E5EAF2', borderRadius: 9, paddingHorizontal: 8 }, tab: { justifyContent: 'center', paddingHorizontal: 20, borderBottomWidth: 3, borderBottomColor: 'transparent' }, tabActive: { borderBottomColor: ACTION }, tabText: { color: '#475467', fontSize: 12, fontWeight: '600' }, tabTextActive: { color: ACTION },
  layout: { flexDirection: 'row', gap: 14, alignItems: 'flex-start', flexWrap: 'wrap' }, main: { flex: 3, minWidth: 620, gap: 14 }, side: { flex: 1, minWidth: 300, gap: 14 }, stats: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 }, stat: { flex: 1, minWidth: 175, minHeight: 88, backgroundColor: 'white', borderRadius: 9, borderWidth: 1, borderColor: '#E5EAF2', padding: 13, flexDirection: 'row', alignItems: 'center', gap: 10 }, statIcon: { width: 40, height: 40, borderRadius: 10, alignItems: 'center', justifyContent: 'center' }, statValue: { color: BLUE, fontSize: 20, fontWeight: '700' }, statLabel: { color: BLUE, fontSize: 12, fontWeight: '600' }, statDetail: { color: '#667085', fontSize: 10, marginTop: 3 },
  card: { backgroundColor: 'white', borderWidth: 1, borderColor: '#E5EAF2', borderRadius: 9, padding: 14 }, cardHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 11, flexWrap: 'wrap', marginBottom: 11 }, cardTitle: { color: BLUE, fontSize: 12, fontWeight: '700', marginBottom: 11 }, searchBox: { minWidth: 270, height: 36, borderWidth: 1, borderColor: '#D7DFEA', borderRadius: 7, flexDirection: 'row', alignItems: 'center', gap: 7, paddingHorizontal: 10 }, searchInput: { flex: 1, color: BLUE, fontSize: 12, outlineStyle: 'none' } as any,
