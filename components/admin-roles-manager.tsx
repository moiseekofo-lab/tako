    ...
    {tab === 'admins' ? <View style={styles.layout}>
      ...
      <View style={styles.side}>
        <View style={styles.card}>
          ...
          <FormField label="Nom complet *" value={form.fullName} placeholder="Entrez le nom complet" onChange={(fullName) => setForm({ ...form, fullName })} />
          <FormField label="E-mail *" value={form.email} placeholder="Entrez l’adresse e-mail" onChange={(email) => setForm({ ...form, email })} />
          <FormField label="Téléphone (optionnel)" value={form.phone} placeholder="Entrez le numéro de téléphone" onChange={(phone) => setForm({ ...form, phone })} />
...
function FormField({ label, value, placeholder, onChange, multiline }: any) { return <View style={styles.field}><Text style={styles.label}>{label}</Text><TextInput style={[styles.input, multiline && styles.textarea]} value={value} placeholder={placeholder} onChangeText={onChange} multiline={multiline} /></View>; }
