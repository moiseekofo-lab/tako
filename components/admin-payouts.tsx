...
export function AdminPayouts() {
  ...
  return <View style={styles.page}>
    ...
    <View style={styles.columns}>
      <View style={styles.tableCard}><Text style={styles.sectionTitle}>Liste des versements</Text><ScrollView horizontal showsHorizontalScrollIndicator={false}><View style={styles.table}>
