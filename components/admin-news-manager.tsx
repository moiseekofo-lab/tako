...
const styles = StyleSheet.create({
  ...
  workspace: { flexDirection: 'row', alignItems: 'flex-start', gap: 13, flexWrap: 'wrap' },
  mainPanel: { flex: 1, minWidth: 520, borderRadius: 10, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: 'white', overflow: 'hidden' },
  tabs: { minHeight: 47, alignItems: 'stretch', paddingHorizontal: 10, borderBottomWidth: 1, borderBottomColor: '#E8EDF4' },
  ...
  tabText: { color: '#475467', fontSize: 12, fontWeight: '600' },
  ...
  searchInput: { flex: 1, height: 36, color: '#14213D', fontSize: 12, outlineStyle: 'none' } as any,
  ...
  filterChipText: { color: '#667085', fontSize: 12, fontWeight: '600' },
  ...
  newsText: { width: 195 },
  cardTitle: { color: BLUE, fontSize: 12, fontWeight: '700' },
  ...
  category: { color: ACTION, fontSize: 11, fontWeight: '700' },
  ...
  badgeText: { color: '#344054', fontSize: 10, fontWeight: '700' },
  ...
  editorTitle: { color: BLUE, fontSize: 16, fontWeight: '700' },
  label: { color: BLUE, fontSize: 12, fontWeight: '700', marginTop: 4 },
  ...
  statusText: { color: '#667085', fontSize: 11, fontWeight: '600' }, statusTextActive: { color: 'white' },
  ...
  dropTitle: { color: ACTION, fontSize: 12, fontWeight: '700', marginTop: 7 },
  ...
  cancelText: { color: BLUE, fontWeight: '700', fontSize: 13 },
  empty: { minHeight: 260, alignItems: 'center', justifyContent: 'center', padding: 30 },
  emptyTitle: { color: BLUE, fontSize: 15, fontWeight: '700', marginTop: 8 },
