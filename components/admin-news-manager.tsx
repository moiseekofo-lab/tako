...
const styles = StyleSheet.create({
  ...
  tabText: { color: '#475467', fontSize: 13, fontWeight: '600' },
  ...
  newsText: { width: 195 },
  cardTitle: { color: BLUE, fontSize: 13, fontWeight: '700' },
  ...
  editorTitle: { color: BLUE, fontSize: 17, fontWeight: '700' },
  ...
  emptyTitle: { color: BLUE, fontSize: 17, fontWeight: '700', marginTop: 10 },
