...
const styles = StyleSheet.create({
  ...
  cardTitleInline: { color: BLUE, fontSize: 17, fontWeight: '700' },
  ...
  page: { gap: 18 }, tabs: { minHeight: 64, flexDirection: 'row', flexWrap: 'wrap', borderRadius: 9, borderWidth: 1, borderColor: '#E3E9F2', backgroundColor: 'white', paddingHorizontal: 10 }, tab: { minHeight: 64, paddingHorizontal: 22, justifyContent: 'center', borderBottomWidth: 3, borderBottomColor: 'transparent' }, tabActive: { borderBottomColor: ACTION }, tabText: { color: '#344054', fontSize: 13, fontWeight: '600' }, tabTextActive: { color: ACTION }, columns: { flexDirection: 'row', alignItems: 'flex-start', gap: 18, flexWrap: 'wrap' }, mainColumn: { flex: 2, minWidth: 520, gap: 18 }, sideColumn: { flex: 1, minWidth: 300, gap: 18 }, card: { borderRadius: 10, borderWidth: 1, borderColor: '#E3E9F2', backgroundColor: 'white', padding: 20 }, cardTitle: { color: BLUE, fontSize: 18, fontWeight: '700', marginBottom: 20 }, personalLayout: { flexDirection: 'row', alignItems: 'flex-start', gap: 38, flexWrap: 'wrap' }, photoColumn: { width: 220, alignItems: 'center', gap: 14 }, avatar: { width: 158, height: 158, borderRadius: 79, backgroundColor: BLUE, alignItems: 'center', justifyContent: 'center' }, details: { flex: 1, minWidth: 260, gap: 18 }, fieldLabel: { color: '#344054', fontSize: 12, fontWeight: '600', marginBottom: 6 }, fieldValue: { color: BLUE, fontSize: 14, fontWeight: '600' }, input: { minHeight: 42, borderRadius: 7, borderWidth: 1, borderColor: '#CCD6E5', paddingHorizontal: 11, color: BLUE, fontSize: 13 }, roleBadge: { alignSelf: 'flex-start', borderRadius: 6, backgroundColor: '#E8F1FF', paddingHorizontal: 10, paddingVertical: 6 }, roleText: { color: ACTION, fontSize: 12, fontWeight: '700' }, primaryButton: { alignSelf: 'flex-start', minHeight: 44, borderRadius: 7, backgroundColor: ACTION, justifyContent: 'center', paddingHorizontal: 16, marginTop: 4 }, primaryText: { color: 'white', fontSize: 13, fontWeight: '700' }, outlineButton: { minHeight: 42, borderRadius: 7, borderWidth: 1, borderColor: '#CCD6E5', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingHorizontal: 14 }, outlineText: { color: BLUE, fontSize: 12, fontWeight: '700' }, companyGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 22 }, companyItem: { width: '46%', minWidth: 230, borderBottomWidth: 1, borderBottomColor: '#EEF2F6', paddingBottom: 12 }, infoRow: { minHeight: 48, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 15, borderBottomWidth: 1, borderBottomColor: '#EEF2F6' }, infoLabel: { color: '#475467', fontSize: 12 }, infoValue: { flex: 1, color: BLUE, fontSize: 12, fontWeight: '600', textAlign: 'right' }, activeBadge: { borderRadius: 99, backgroundColor: '#DDF8E8', paddingHorizontal: 10, paddingVertical: 5 }, activeText: { color: '#07833C', fontSize: 11, fontWeight: '700' }, securityCard: { borderRadius: 10, borderWidth: 1, borderColor: '#BDD7FF', backgroundColor: '#F5F9FF', padding: 20, gap: 12 }, securityTitle: { flexDirection: 'row', alignItems: 'center', gap: 10 }, securityHeading: { color: ACTION, fontSize: 17, fontWeight: '700' }, securityIntro: { color: '#475467', fontSize: 12 }, tip: { flexDirection: 'row', alignItems: 'center', gap: 8 }, tipText: { color: '#344054', fontSize: 12, fontWeight: '500' }, placeholder: { color: '#667085', fontSize: 14, lineHeight: 21, marginBottom: 14 },
});
