...
const styles = StyleSheet.create({
  ...
  securityColumns: { flexDirection: 'row', alignItems: 'flex-start', gap: 14, flexWrap: 'wrap' },
  securityMain: { flex: 2, minWidth: 520, gap: 14 },
  securitySide: { flex: 1, minWidth: 300, gap: 14 },
  securitySection: { borderRadius: 10, borderWidth: 1, borderColor: '#E3E9F2', backgroundColor: 'white', padding: 16, flexDirection: 'row', alignItems: 'flex-start', gap: 13 },
  ...
  sectionTitle: { color: BLUE, fontSize: 15, fontWeight: '700' },
  sectionDescription: { color: '#667085', fontSize: 12, lineHeight: 18, marginTop: 4 },
  sectionContent: { marginTop: 13 },
  ...
  sessionRow: { minHeight: 50, borderRadius: 7, borderWidth: 1, borderColor: '#E3E9F2', flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 11 },
  activeNow: { color: '#07833C', fontSize: 11, fontWeight: '700' },
  cardTitleInline: { color: BLUE, fontSize: 12, fontWeight: '700' },
  activityRow: { minHeight: 50, flexDirection: 'row', alignItems: 'center', gap: 8, borderBottomWidth: 1, borderBottomColor: '#EEF2F6' },
  activityTitle: { color: BLUE, fontSize: 12, fontWeight: '700' },
  page: { gap: 14 }, tabs: { minHeight: 52, flexDirection: 'row', flexWrap: 'wrap', borderRadius: 9, borderWidth: 1, borderColor: '#E3E9F2', backgroundColor: 'white', paddingHorizontal: 8 }, tab: { minHeight: 52, paddingHorizontal: 18, justifyContent: 'center', borderBottomWidth: 3, borderBottomColor: 'transparent' }, tabActive: { borderBottomColor: ACTION }, tabText: { color: '#344054', fontSize: 12, fontWeight: '600' }, tabTextActive: { color: ACTION }, columns: { flexDirection: 'row', alignItems: 'flex-start', gap: 14, flexWrap: 'wrap' }, mainColumn: { flex: 2, minWidth: 520, gap: 14 }, sideColumn: { flex: 1, minWidth: 300, gap: 14 }, card: { borderRadius: 10, borderWidth: 1, borderColor: '#E3E9F2', backgroundColor: 'white', padding: 16 }, cardTitle: { color: BLUE, fontSize: 12, fontWeight: '700', marginBottom: 16 }, personalLayout: { flexDirection: 'row', alignItems: 'flex-start', gap: 30, flexWrap: 'wrap' }, photoColumn: { width: 190, alignItems: 'center', gap: 11 }, avatar: { width: 128, height: 128, borderRadius: 64, backgroundColor: BLUE, alignItems: 'center', justifyContent: 'center' }, details: { flex: 1, minWidth: 260, gap: 14 }, fieldLabel: { color: '#344054', fontSize: 11, fontWeight: '600', marginBottom: 5 }, fieldValue: { color: BLUE, fontSize: 12, fontWeight: '600' }, input: { minHeight: 36, borderRadius: 7, borderWidth: 1, borderColor: '#CCD6E5', paddingHorizontal: 10, color: BLUE, fontSize: 12 }, roleBadge: { alignSelf: 'flex-start', borderRadius: 6, backgroundColor: '#E8F1FF', paddingHorizontal: 8, paddingVertical: 5 }, roleText: { color: ACTION, fontSize: 11, fontWeight: '700' }, primaryButton: { alignSelf: 'flex-start', minHeight: 38, borderRadius: 7, backgroundColor: ACTION, justifyContent: 'center', paddingHorizontal: 13, marginTop: 4 }, primaryText: { color: 'white', fontSize: 12, fontWeight: '700' }, outlineButton: { minHeight: 36, borderRadius: 7, borderWidth: 1, borderColor: '#CCD6E5', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7, paddingHorizontal: 11 }, outlineText: { color: BLUE, fontSize: 11, fontWeight: '700' }, companyGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 18 }, companyItem: { width: '46%', minWidth: 230, borderBottomWidth: 1, borderBottomColor: '#EEF2F6', paddingBottom: 10 }, infoRow: { minHeight: 40, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12, borderBottomWidth: 1, borderBottomColor: '#EEF2F6' }, infoLabel: { color: '#475467', fontSize: 11 }, infoValue: { flex: 1, color: BLUE, fontSize: 12, fontWeight: '600', textAlign: 'right' }, activeBadge: { borderRadius: 99, backgroundColor: '#DDF8E8', paddingHorizontal: 8, paddingVertical: 4 }, activeText: { color: '#07833C', fontSize: 10, fontWeight: '700' }, securityCard: { borderRadius: 10, borderWidth: 1, borderColor: '#BDD7FF', backgroundColor: '#F5F9FF', padding: 16, gap: 10 }, securityTitle: { flexDirection: 'row', alignItems: 'center', gap: 8 }, securityHeading: { color: ACTION, fontSize: 15, fontWeight: '700' }, securityIntro: { color: '#475467', fontSize: 11 }, tip: { flexDirection: 'row', alignItems: 'center', gap: 7 }, tipText: { color: '#344054', fontSize: 11, fontWeight: '500' }, placeholder: { color: '#667085', fontSize: 11, lineHeight: 18, marginBottom: 11 },
});
